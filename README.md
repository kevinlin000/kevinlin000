...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:1a2a6c,50:2a5298,100:36d1dc&height=200&section=header&text=Kevin%20Lin&fontSize=60&fontColor=ffffff&animation=fadeIn&desc=Backend%20Engineer%20%7C%20Java%20%2F%20Spring%20Boot%20%E2%80%A2%20AI%20Application%20%E2%80%A2%20Data%20Engineering&descAlignY=75&descSize=16" width="100%"/>

<a href="https://github.com/kevinlin000">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=36D1DC&center=true&vCenter=true&width=700&lines=Java+17+%2F+Spring+Boot+3+Backend+Developer;2+deployed+transaction+systems+%E2%80%A2+idempotent+payments;AI+Agent+%E2%80%A2+RAG+%E2%80%A2+Versioned+Evals+%E2%80%A2+LLMOps;Redisson+locks+%E2%80%A2+Redis+Lua+%E2%80%A2+RabbitMQ+%E2%80%A2+4M%2B+records" alt="Typing SVG" />
</a>

<br/>

[![Java](https://img.shields.io/badge/Backend-Java%2017%20%2F%20Spring%20Boot%203-b07219?style=for-the-badge&logo=openjdk&logoColor=white)](https://github.com/kevinlin000)
[![AI](https://img.shields.io/badge/AI-Agent%20%2F%20RAG%20%2F%20LLMOps-8A2BE2?style=for-the-badge&logo=googlegemini&logoColor=white)](https://github.com/kevinlin000)
[![Cloud](https://img.shields.io/badge/Cloud-AWS%20%2F%20GCP-FF9900?style=for-the-badge&logo=amazonwebservices&logoColor=white)](https://github.com/kevinlin000)
[![Profile Views](https://komarev.com/ghpvc/?username=kevinlin000&style=for-the-badge&color=36d1dc)](https://github.com/kevinlin000)
...
- 🏗️ 獨立完成 **2 個部署上線的交易系統**：狀態機、金流冪等、Redisson 分散式鎖與併發控制
...
- 🛡️ Guardrails：prompt injection 防護、敏感內容過濾、單次對話限一筆訂位
...
> 設備報修 → 維修工單 → 主管審批 → 結案與稽核追蹤。核心為**應用層工單狀態機**：轉換規則可測試、可版控，非法轉換在 API 層明確拒絕。
...
- 🔐 AI 權限邊界：RAG 服務僅依賴**唯讀介面**，以測試固定此約束；檢索命中率 / 引用正確率 / 拒答正確率納入 CI 離線評測（固定輸出測試替身）；以 ADR 記錄暫不上 ANN 索引的取捨

### 🚲 YouBike 2.0｜站點風險預測與調度工作台
**個人專案・ccclub 2025 秋季班特優** | `Python` `Airflow` `MySQL` `FastAPI` `Streamlit` `PyTorch (LSTM)` `Docker` `GCP`
...
- ⏱️ Airflow 每 10 分鐘擷取站點狀態寫入 MySQL，累積 **400 萬筆以上**；靜態/高頻資料分離、唯一鍵防重複
...
- 🧭 保留 baseline 比較與模型限制說明 — LSTM 尚未穩定優於最強 baseline，定位為**模型服務化原型**而非高準確度模型

### 🌅 敘日｜餐廳管理系統（5 人團隊・組長）
**資展國際 Java 養成班結訓專題** | `Spring Boot` `Spring Security` `Vue 3` `MySQL`
...
**緯育 TibaMe 結訓專題（負責清洗模組＋獨立優化）** | `Python` `Scrapy` `Kafka` `Airflow` `MySQL` `Gemini API` `GCP`
...
[![GitHub](https://img.shields.io/badge/GitHub-kevinlin000-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/kevinlin000)
[![Email](https://img.shields.io/badge/Email-Contact%20Me-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:guguji1444@gmail.com)

<img src="https://capsule-render.vercel.app/api?type=waving&color=0:36d1dc,50:2a5298,100:1a2a6c&height=120&section=footer" width="100%"/>
